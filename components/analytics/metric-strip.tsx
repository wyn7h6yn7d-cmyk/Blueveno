...
export function MetricStrip({ items, className }: MetricStripProps) {
  return (
    <section
      className={cn(
        "grid gap-3 rounded-2xl border border-[oklch(0.52_0.12_252/0.2)] bg-[linear-gradient(165deg,oklch(0.14_0.038_262/0.94),oklch(0.09_0.03_266/0.92))] p-4 shadow-[inset_0_1px_0_0_oklch(1_0_0/0.05),0_0_40px_-24px_oklch(0.45_0.14_252/0.4)] sm:grid-cols-2 sm:gap-4 sm:p-5 lg:grid-cols-5",
        className,
      )}
