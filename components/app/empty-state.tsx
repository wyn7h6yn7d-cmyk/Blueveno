...
export function EmptyState({ icon: Icon, title, description, action, className }: EmptyStateProps) {
  return (
    ...
    >
      ...
      <h3 className="font-display mt-4 text-base font-medium tracking-tight text-zinc-100">{title}</h3>
      <p className="mt-2 max-w-md text-[15px] leading-relaxed text-zinc-400">{description}</p>
