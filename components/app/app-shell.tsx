...
import { AppToastProvider } from "@/components/app/app-toast-provider";
      ...
      <TradingAccountsProvider userId={user.id}>
        ...
        <div className="flex min-h-full min-w-0 flex-1 flex-col">
          ...
          <div className="relative flex-1">
            ...
            <WorkspaceGate>
              <div className={cn("relative min-h-full px-3 py-5 sm:px-6 sm:py-8 md:px-8 md:py-9 lg:px-10 lg:py-10", appContentWrap)}>
                {children}
              </div>
            </WorkspaceGate>
          </div>
