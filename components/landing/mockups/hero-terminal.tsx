...
export function HeroTerminal() {
  return (
    <TerminalFrame title="blueveno · performance review" variant="hero">
      <div className="relative overflow-hidden">
        <div className="pointer-events-none absolute inset-0 bg-grid-fine opacity-[0.38]" aria-hidden />
        ...
        <div className="relative grid gap-0 p-5 md:grid-cols-[1fr_200px] md:gap-6 md:p-6">
          <div>
            <div className="mb-5 flex flex-wrap items-end justify-between gap-4">
              ...
              <div className="flex gap-3">
                {[
                  ...
                  <div
                    key={x.l}
                    className="rounded-lg border border-white/[0.07] bg-white/[0.03] px-3 py-2 text-right shadow-[inset_0_1px_0_0_oklch(1_0_0_/0.04)]"
                  >
                    <p className="font-mono text-[9px] uppercase tracking-wider text-zinc-500">{x.l}</p>
            ...
            <div className="relative h-44 overflow-hidden rounded-xl border border-white/[0.07] bg-[oklch(0.07_0.03_265)] shadow-[inset_0_0_0_1px_oklch(1_0_0_/0.03)] md:h-52">
              <div className="absolute inset-0 bg-grid-fine opacity-25" />
              <div className="pointer-events-none absolute left-3 top-3 font-mono text-[8px] uppercase tracking-wider text-zinc-600">
                Equity · 90d
              </div>
          ...
          <div className="mt-4 flex flex-col justify-between border-t border-white/[0.05] pt-4 md:mt-0 md:border-t-0 md:border-l md:pt-0 md:pl-6">
            <div>
              <p className="font-mono text-[10px] uppercase tracking-[0.22em] text-zinc-500">Desk signals</p>
              <ul className="mt-3 space-y-2">
                {[
                  ...
                  <li
                    key={row.k}
                    className="flex items-center justify-between rounded-md border border-white/[0.05] bg-white/[0.025] px-2.5 py-1.5 shadow-[inset_0_1px_0_0_oklch(1_0_0_/0.03)]"
                  >
            ...
            <p className="mt-4 font-mono text-[9px] leading-relaxed text-zinc-600">
              Ingestion is automatic. Review stays bound to what printed.
            </p>
          </div>
        </div>

        <div className="flex flex-wrap gap-1 border-t border-white/[0.06] bg-black/35 px-4 py-3">
